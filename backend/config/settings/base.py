...
if DEBUG:
    ...
    CSRF_TRUSTED_ORIGINS = ["http://127.0.0.1:3000", "http://0.0.0.0:3000", "http://localhost:3000","http://192.168.1.30:3000", "http://192.168.56.1:3000", "http://192.168.1.90:3000", "http://192.168.110.1:3000"]
    CSRF_TRUSTED_ORIGINS += env.list("CSRF_TRUSTED_ORIGINS", [])
